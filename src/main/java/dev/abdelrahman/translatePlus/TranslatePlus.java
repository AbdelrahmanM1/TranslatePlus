...
public final class TranslatePlus extends JavaPlugin {
    ...
    public GoogleTranslateService getGoogleTranslateService() {
        ...
        Object activeService = serviceManager.getActiveService();

        // Check if the active service is actually a GoogleTranslateService
        if (activeService instanceof GoogleTranslateService) {
            return (GoogleTranslateService) activeService;
        }
