...
public class ConfigManager {
    ...
    public void loadConfig() {
        ...
        config.addDefault("translation-service", "google"); // New: service selection
        config.addDefault("google-api-key", "PUT-YOUR-GOOGLE-KEY-HERE");
        config.addDefault("openai-api-key", "PUT-YOUR-OPENAI-KEY-HERE"); // New: OpenAI key
        ...
        config.addDefault("messages.enabled", "&aTranslation enabled! Target language: %lang% (via %service%)");
        config.addDefault("messages.disabled", "&cTranslation disabled!");
        config.addDefault("messages.status", "&eYour translation is %status% (Language: %lang%, Service: %service%)");
        ...
        config.addDefault("messages.usage", "&eUsage: /translate <on|off|status|help|list|reload|setdefault|service>");
        ...
        config.addDefault("messages.same-language", "&eMessage is already in your target language!");
        ...
        config.addDefault("messages.service-changed", "&aTranslation service changed to %service%!");
        config.addDefault("messages.service-status", "&eCurrent translation service: %service%");
