...
public class ConfigManager {
    ...
    public void loadConfig() {
        ...
        config.addDefault("google-api-key", "PUT-YOUR-KEY-HERE");
        ...
        config.addDefault("messages.no-api-key", "&cGoogle Translate API key not set in config!");
        ...
        // Translation blacklist defaults - expanded list
        ...
        // Language settings defaults - expanded lists
    ...
    private void cacheCommonValues() {
        configCache.put("api-key", config.getString("google-api-key", "PUT-YOUR-KEY-HERE"));
    ...
    public String getApiKey() {
        return (String) configCache.computeIfAbsent("api-key",
                k -> config.getString("google-api-key", "PUT-YOUR-KEY-HERE"));
    }
    ...
    public void setDefaultLanguage(String language) {
        ...
        plugin.saveConfig();
        configCache.put("default-language", language); // Update cache
    ...
    public boolean isApiKeyConfigured() {
        ...
        boolean isConfigured = apiKey != null && !apiKey.equals("PUT-YOUR-KEY-HERE") && !apiKey.trim().isEmpty();

        if (!isConfigured) {
            debugLog("API key is not properly configured");
        }
