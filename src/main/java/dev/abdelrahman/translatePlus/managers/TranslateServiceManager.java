...
public class TranslateServiceManager {
    ...
    /**
     * Get the name of the currently active service (uppercase for display)
     */
    ...
    /**
     * Get the raw active service identifier (lowercase)
     * This returns the actual string used internally (e.g., "google", "openai")
     */
    ...
    /**
     * Get the formatted service name for display in messages
     * This is what should be used for the %service% placeholder
     */
    public String getServiceDisplayName() {
        ...
        switch (activeService.toLowerCase()) {
            case "google":
                return "GOOGLE";
            case "openai":
                return "OPENAI";
            default:
                return activeService.toUpperCase();
        }
    }

    /**
     * Get the active service instance (returns the actual service object)
     * Use this when you need the actual service object, not the name
     */
    public Object getActiveServiceInstance() {
        if ("openai".equals(activeService)) {
            return openaiService;
        } else if ("google".equals(activeService)) {
